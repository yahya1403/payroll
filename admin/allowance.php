...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
  ...
  <li class="nav-item">
    ...
    <li class="nav-item">
      <a class="navbar-brand material-icons nav-active" href="allowance.php">Allowance / Deduction  <i class="fas fa-money-bill-alt"></i></a>
    </li>
    <li class="nav-item">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control js-name-add" id="exampleInputPassword1" placeholder="AD Name">
          </div>
          <div class="form-group">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form>
            ...
            <div class="form-group">
              <label for="ADname">AD Name</label>
              <input type="text" class="form-control js-name-edit" id="exampleInputPassword1" placeholder="AD Name">
            </div>
            <div class="form-group">
              <label for="AD flagcode">AD flag </label>
