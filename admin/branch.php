...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
  ...
  <li class="nav-item">
    ...
    <li class="nav-item">
      <a class="navbar-brand material-icons  nav-active" href="branch.php">Branch  <i class="fas fa-code-branch"></i></a>
    </li>
    <li class="nav-item">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control js-branch-add" id="exampleInputEmail1" placeholder="Branch code">
          </div>
          <div class="form-group">
            <label for="Branchname">Branch Name</label>
            <input type="text" class="form-control js-name-add" id="exampleInputPassword1" placeholder="Branch Name">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="bspcode">BSP Code</label>
            <input type="text" class="form-control js-bsp-add" id="exampleInputPassword1" placeholder="BSP Code">
          </div>
        </form>
      </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="form-group">
                <label for="Branchcode">Branch Code</label>
                <input type="text" class="form-control js-branch-edit" id="exampleInputEmail1" placeholder="Division code">
            </div>
            <div class="form-group">
                <label for="Branchname">Branch Name</label>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control js-bsp-edit" id="exampleInputPassword1" placeholder="Acoount Code">
            </div>
            </form>
      </div>
...
<script src="custom/branch.js"></script>
